...
import { FiBook, FiCode, FiGlobe, FiArrowRight, FiZap, FiTool } from 'react-icons/fi';
...
const JQueryCourse = () => {
  ...
  useEffect(() => {
    if (location.pathname === '/jquery-course') {
  ...
  return (
    <div className="flex min-h-screen bg-gray-50">
      ...
      <div className="fixed top-0 left-0 w-64 h-screen bg-white shadow-lg overflow-y-auto">
        <div className="p-4">
          <h2 className="text-xl font-bold text-gray-800 mb-4">jQuery Course</h2>
          <nav>
