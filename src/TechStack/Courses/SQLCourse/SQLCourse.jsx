...
import { FiDatabase, FiList, FiTerminal, FiGitMerge, FiServer, FiLock, FiCode, FiBookOpen } from 'react-icons/fi';
...
const SQLCourse = () => {
  ...
  useEffect(() => {
    if (location.pathname === '/sql-course') {
  ...
  return (
    <div className="flex min-h-screen bg-gray-50">
      ...
      <div className="fixed top-0 left-0 w-64 h-screen bg-white shadow-lg overflow-y-auto">
        <div className="p-4">
          <h2 className="text-xl font-bold text-gray-800 mb-4">SQL Course</h2>
          <nav>
