...
import { FiBook, FiCode, FiBox, FiAlertCircle, FiCheckCircle, FiTool } from 'react-icons/fi';
...
const categoryIcons = {
  ...
  methods: <FiCode />,
  oop: <FiBox />,
  error_handling: <FiAlertCircle />,
  practice: <FiCheckCircle />,
  advanced: <FiTool />
};
...
const CSharpCourse = () => {
  ...
  useEffect(() => {
    if (location.pathname === '/csharp-course') {
  ...
  return (
    <div className="flex min-h-screen bg-gray-50">
      ...
      <div className="fixed top-0 left-0 w-64 h-screen bg-white shadow-lg overflow-y-auto">
        <div className="p-4">
          <h2 className="text-xl font-bold text-gray-800 mb-4">C# Course</h2>
          <nav>
