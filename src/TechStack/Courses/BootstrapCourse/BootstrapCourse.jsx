...
import { FiBook, FiBox, FiLayout, FiSliders, FiEdit, FiGrid, FiTool, FiBookOpen } from 'react-icons/fi';
...
const categoryIcons = {
  ...
  components: <FiBox />,
  layout: <FiLayout />,
  interactive: <FiSliders />,
  forms: <FiEdit />,
  grid: <FiGrid />,
  utilities: <FiTool />,
  resources: <FiBookOpen />
};
...
const BootstrapCourse = () => {
  ...
  useEffect(() => {
    if (location.pathname === '/bootstrap-course') {
  ...
  return (
    <div className="flex min-h-screen bg-gray-50">
      ...
      <div className="hidden md:fixed md:top-16 md:left-0 md:w-64 md:h-[calc(100vh-4rem)] md:bg-white md:shadow-lg md:overflow-y-auto md:block">
        <div className="p-4">
          <h2 className="text-xl font-bold text-gray-800 mb-4">Bootstrap 5 Course</h2>
          <nav>
