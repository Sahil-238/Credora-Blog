...
import logo_dark from './logo_dark.svg?url'
import search_icon from './search_icon.svg?url'
import cross_icon from './cross_icon.svg?url'
import upload_area from './upload_area.svg?url'
import sketch from './sktech.svg?url'
import microsoft_logo from './microsoft_logo.svg?url'
import walmart_logo from './walmart_logo.svg?url'
import accenture_logo from './accenture_logo.svg?url'
import adobe_logo from './adobe_logo.svg?url'
import paypal_logo from './paypal_logo.svg?url'
import course_1_thumbnail from './course_1.png'
import course_2_thumbnail from './course_2.png'
import course_3_thumbnail from './course_3.png'
import course_4_thumbnail from './course_4.png'
import star from './rating_star.svg?url'
import star_blank from './star_dull_icon.svg?url'
import profile_img_1 from './profile_img_1.png'
import profile_img_2 from './profile_img_2.png'
import profile_img_3 from './profile_img_3.png'
import arrow_icon from './arrow_icon.svg?url'
import down_arrow_icon from './down_arrow_icon.svg?url'
import time_left_clock_icon from './time_left_clock_icon.svg?url'
import time_clock_icon from './time_clock_icon.svg?url'
import user_icon from './user_icon.svg?url'
import home_icon from './home_icon.svg?url'
import add_icon from './add_icon.svg?url'
import my_course_icon from './my_course_icon.svg?url'
import person_tick_icon from './person_tick_icon.svg?url'
import facebook_icon from './facebook_icon.svg?url'
import instagram_icon from './instagram_icon.svg?url'
import twitter_icon from './twitter_icon.svg?url'
import file_upload_icon from './file_upload_icon.svg?url'
import appointments_icon from './appointments_icon.svg?url'
import earning_icon from './earning_icon.svg?url'
import dropdown_icon from './dropdown_icon.svg?url'
import patients_icon from './patients_icon.svg?url'
import play_icon from './play_icon.svg?url'
import blue_tick_icon from './blue_tick_icon.svg?url'
import course_4 from './course_4.png'
import profile_img from './profile_img.png'
import profile_img2 from './profile_img2.png'
import profile_img3 from './profile_img3.png'
import lesson_icon from './lesson_icon.svg?url'
